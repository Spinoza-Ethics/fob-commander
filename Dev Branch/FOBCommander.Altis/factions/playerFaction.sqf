...
_playerFaction set ["unitTypes", [
    ["Recruit Rifleman", "B_Soldier_F"],
    ["Recruit Marksman", "B_soldier_M_F"],
    ["Recruit Engineer", "B_engineer_F"],
    ["Recruit Medic", "B_medic_F"],
    ["Recruit AA Specialist", "B_soldier_AA_F"],
    ["Recruit AT Specialist", "B_soldier_AT_F"],
    ["Recruit Grenadier", "B_Soldier_GL_F"],
    ["Recruit Heavy Gunner", "B_HeavyGunner_F"],
    ["Recruit Sharpshooter", "B_Sharpshooter_F"],
    ["Recruit UAV Operator", "B_soldier_UAV_F"]
]];
